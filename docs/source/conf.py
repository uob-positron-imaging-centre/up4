...
_PACKAGE_DIR = os.path.abspath(os.path.join(_ROOT_DIR, "up4"))
_SUBPACKAGE_DIR = os.path.abspath(os.path.join(_PACKAGE_DIR, "plotting"))
...
about = {}
with open(f"{_PACKAGE_DIR}/__version__.py") as f:
    exec(f.read(), about)
...
latex_documents = [
    ("index", "up4.tex", "up4 Documentation", "up4 maintainers", "manual"),
]
