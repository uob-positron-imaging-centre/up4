...
impl Rgb {
    ...
    fn from_rgb_string(rgb_string: String) -> Rgb {
        ...
        let rgb_vec = vec![rgb_strings[0].parse::<u8>().unwrap(), rgb_strings[1].parse::<u8>().unwrap(), rgb_strings[2].parse::<u8>().unwrap()];
...
impl ColorScalePaletteRawValues {
    fn get_values(cmap: ColorScalePalette) -> Vec<String>{
        match cmap {
            ...
            ColorScalePalette::Bluered => convert_to_string(vec![
                "rgb(0,0,255)", 
                "rgb(255,0,0)",
                ]),
            ColorScalePalette::RdBu => convert_to_string(vec!["rgb(103,0,31)", "rgb(178,24,43)", "rgb(214,96,77)", "rgb(244,165,130)", "rgb(253,219,199)", "rgb(247,247,247)", "rgb(209,229,240)", "rgb(146,197,222)", "rgb(67,147,195)", "rgb(33,102,172)", "rgb(5,48,97)", ]),
